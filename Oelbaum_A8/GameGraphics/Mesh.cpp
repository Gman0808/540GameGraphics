...
Mesh::Mesh(Vertex vertices[], int vCount, unsigned int indices[], int indicesCount, Microsoft::WRL::ComPtr<ID3D11Device> bufferPointer)
{

	CreateBuffers(vertices, vCount, indices, indicesCount, bufferPointer);
...
void Mesh::CreateBuffers(Vertex* vertArray, int numVerts, unsigned int* indexArray, int numIndices, Microsoft::WRL::ComPtr<ID3D11Device> device)
{
	...
	// Save the indices
	this->indCounter = numIndices;
}

void Mesh::drawShape(Microsoft::WRL::ComPtr<ID3D11DeviceContext> context)
{
